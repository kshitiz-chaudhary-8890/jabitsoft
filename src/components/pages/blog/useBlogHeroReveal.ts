...
/**
 * Blog hero reload reveal — same masked cascade as the other heroes
 * (Minati-style: shell slides up while masked pieces rise inside it).
 */
...
export function useBlogHeroReveal(
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const rises = shell.querySelectorAll<HTMLElement>(`.${styles.riseInner}`);
